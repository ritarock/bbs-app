...
//
//	mockgen -source=./domain/post.go -destination=./testing/mock/post.go -package=mock
//
...
func (mr *MockPostUsecaseMockRecorder) Delete(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Delete", reflect.TypeOf((*MockPostUsecase)(nil).Delete), ctx, id)
}
...
func (m *MockPostUsecase) Update(ctx context.Context, post *domain.Post, id int) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Update", ctx, post, id)
	ret0, _ := ret[0].(error)
	return ret0
}

// Update indicates an expected call of Update.
func (mr *MockPostUsecaseMockRecorder) Update(ctx, post, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Update", reflect.TypeOf((*MockPostUsecase)(nil).Update), ctx, post, id)
}
...
// Update mocks base method.
func (m *MockPostRepository) Update(ctx context.Context, post *domain.Post, id int) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Update", ctx, post, id)
	ret0, _ := ret[0].(error)
	return ret0
...
// Update indicates an expected call of Update.
func (mr *MockPostRepositoryMockRecorder) Update(ctx, post, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Update", reflect.TypeOf((*MockPostRepository)(nil).Update), ctx, post, id)
}
