...
//
//	mockgen -source=./port/post.go -destination=./testing/mock/post.go -package=mock
//
...
func (m *MockPostRepository) Update(ctx context.Context, postID int, post *domain.Post) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Update", ctx, postID, post)
	ret0, _ := ret[0].(error)
	return ret0
}

// Update indicates an expected call of Update.
func (mr *MockPostRepositoryMockRecorder) Update(ctx, postID, post any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Update", reflect.TypeOf((*MockPostRepository)(nil).Update), ctx, postID, post)
}
...
// Create mocks base method.
func (m *MockPostUsecase) Create(ctx context.Context, post *domain.Post) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", ctx, post)
	ret0, _ := ret[0].(error)
	return ret0
...
// Create indicates an expected call of Create.
func (mr *MockPostUsecaseMockRecorder) Create(ctx, post any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockPostUsecase)(nil).Create), ctx, post)
}

// Delete mocks base method.
func (m *MockPostUsecase) Delete(ctx context.Context, postID int) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Delete", ctx, postID)
	ret0, _ := ret[0].(error)
	return ret0
...
// Delete indicates an expected call of Delete.
func (mr *MockPostUsecaseMockRecorder) Delete(ctx, postID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Delete", reflect.TypeOf((*MockPostUsecase)(nil).Delete), ctx, postID)
}
...
// GetAll indicates an expected call of GetAll.
func (mr *MockPostUsecaseMockRecorder) GetAll(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAll", reflect.TypeOf((*MockPostUsecase)(nil).GetAll), ctx)
}
...
// GetByID indicates an expected call of GetByID.
func (mr *MockPostUsecaseMockRecorder) GetByID(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetByID", reflect.TypeOf((*MockPostUsecase)(nil).GetByID), ctx, id)
}

// Update mocks base method.
func (m *MockPostUsecase) Update(ctx context.Context, postID int, post *domain.Post) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Update", ctx, postID, post)
	ret0, _ := ret[0].(error)
	return ret0
...
// Update indicates an expected call of Update.
func (mr *MockPostUsecaseMockRecorder) Update(ctx, postID, post any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Update", reflect.TypeOf((*MockPostUsecase)(nil).Update), ctx, postID, post)
}
