...
func (m *CommentMutation) SetCommentedAt(t time.Time) {
	m.commented_at = &t
}

// CommentedAt returns the value of the "commented_at" field in the mutation.
func (m *CommentMutation) CommentedAt() (r time.Time, exists bool) {
	v := m.commented_at
	if v == nil {
		return
	}
...
// OldCommentedAt returns the old "commented_at" field's value of the Comment entity.
// If the Comment object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CommentMutation) OldCommentedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldCommentedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldCommentedAt requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldCommentedAt: %w", err)
	}
	return oldValue.CommentedAt, nil
}

// ResetCommentedAt resets all changes to the "commented_at" field.
func (m *CommentMutation) ResetCommentedAt() {
	m.commented_at = nil
}
...
func (m *CommentMutation) Fields() []string {
	...
	if m.commented_at != nil {
		fields = append(fields, comment.FieldCommentedAt)
	}
	if m.post != nil {
...
func (m *CommentMutation) Field(name string) (ent.Value, bool) {
	...
	case comment.FieldContent:
		return m.Content()
	case comment.FieldCommentedAt:
		return m.CommentedAt()
...
func (m *PostMutation) SetPostedAt(t time.Time) {
	m.posted_at = &t
}

// PostedAt returns the value of the "posted_at" field in the mutation.
func (m *PostMutation) PostedAt() (r time.Time, exists bool) {
	v := m.posted_at
	if v == nil {
		return
	}
...
// If the Post object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *PostMutation) OldPostedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
