...
func (tq *TopicQuery) First(ctx context.Context) (*Topic, error) {
	nodes, err := tq.Limit(1).All(newQueryContext(ctx, TypeTopic, "First"))
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {
...
func (tq *TopicQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
	if ids, err = tq.Limit(1).IDs(newQueryContext(ctx, TypeTopic, "FirstID")); err != nil {
		return
	}
	if len(ids) == 0 {
...
func (tq *TopicQuery) Only(ctx context.Context) (*Topic, error) {
	nodes, err := tq.Limit(2).All(newQueryContext(ctx, TypeTopic, "Only"))
	if err != nil {
		return nil, err
	}
	switch len(nodes) {
...
func (tq *TopicQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
	if ids, err = tq.Limit(2).IDs(newQueryContext(ctx, TypeTopic, "OnlyID")); err != nil {
		return
	}
	switch len(ids) {
	case 1:
...
func (tq *TopicQuery) All(ctx context.Context) ([]*Topic, error) {
	ctx = newQueryContext(ctx, TypeTopic, "All")
	if err := tq.prepareQuery(ctx); err != nil {
		return nil, err
	}
...
func (tq *TopicQuery) IDs(ctx context.Context) ([]int, error) {
	var ids []int
	ctx = newQueryContext(ctx, TypeTopic, "IDs")
...
func (tq *TopicQuery) Count(ctx context.Context) (int, error) {
	ctx = newQueryContext(ctx, TypeTopic, "Count")
	if err := tq.prepareQuery(ctx); err != nil {
		return 0, err
	}
...
func (tq *TopicQuery) Exist(ctx context.Context) (bool, error) {
	ctx = newQueryContext(ctx, TypeTopic, "Exist")
...
func (tq *TopicQuery) loadComments(ctx context.Context, query *CommentQuery, nodes []*Topic, init func(*Topic), assign func(*Topic, *Comment)) error {
	...
	query.Where(predicate.Comment(func(s *sql.Selector) {
		s.Where(sql.InValues(topic.CommentsColumn, fks...))
	}))
...
func (tgb *TopicGroupBy) Scan(ctx context.Context, v any) error {
	ctx = newQueryContext(ctx, TypeTopic, "GroupBy")
...
func (ts *TopicSelect) Scan(ctx context.Context, v any) error {
	ctx = newQueryContext(ctx, TypeTopic, "Select")
