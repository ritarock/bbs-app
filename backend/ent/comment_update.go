...
func (cu *CommentUpdate) ClearTopicID() *CommentUpdate {
	cu.mutation.ClearTopicID()
	return cu
}
...
// ClearTopicID clears the value of the "topic_id" field.
func (cuo *CommentUpdateOne) ClearTopicID() *CommentUpdateOne {
	cuo.mutation.ClearTopicID()
	return cuo
}
